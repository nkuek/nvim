...
vim.keymap.set('i', '<C-h>', '<C-w><C-h>', { desc = 'Move focus to the left window' })
vim.keymap.set('i', '<C-l>', '<C-w><C-l>', { desc = 'Move focus to the right window' })
vim.keymap.set('i', '<C-j>', '<C-w><C-j>', { desc = 'Move focus to the lower window' })
...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').add {
        {
          { '<leader><leader>', group = 'Apply changes' },
          { '<leader><leader>_', hidden = true },
          { '<leader>Y', group = 'Hard [Y]ank to +clipboard' },
          ...
          { '<leader>y', group = 'Soft [y]ank to +clipboard' },
          { '<leader>y_', hidden = true },
        },
      }
      -- visual mode
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sf', function()
        builtin.find_files { hidden = true, file_ignore_patterns = { '.git', 'node_modules' } }
      ...
      vim.keymap.set('n', '<leader>f', buffer_searcher, { desc = '[F]ind existing buffers' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'javascript', 'typescript', 'glsl' },
    ...
    config = function(_, opts)
      ...
      parser_config.glsl.filetype = { 'glsl', 'vert', 'frag' }
